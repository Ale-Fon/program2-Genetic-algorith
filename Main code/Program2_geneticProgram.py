...
class Schedule:
    ...
    def fitness(self):
        score = 0.0
        used_slots = defaultdict(list)  # (time, room) -> list of activities
        facilitator_slots = defaultdict(list)  # (time) -> list of facilitators
        ...
        # Facilitator double-booking and load
        ...
        # This function is a specific scheduling rules for SLA101/SLA191
        def hour(t):
